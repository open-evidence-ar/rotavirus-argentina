...
about: Aportar nueva evidencia factual para el informe
title: "[EVIDENCIA] "
labels: evidence
---
...
## Tipo de evidencia
- [ ] Observado (dato directo de literatura peer-reviewed u organismo oficial)
...
## Fuente alternativa
<!-- ¿Existe otra fuente que valide o refute este dato? (opcional) -->
